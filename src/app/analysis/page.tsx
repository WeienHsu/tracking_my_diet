            ...
            {landing.total === 0 ? (
              ...
              <>
                ...
                <div className="grid grid-cols-3 gap-2 text-center text-sm">
                  <Stat label="理想" value={landing.idealCount} color="text-green-700" />
                  <Stat label="偏高" value={landing.highCount} color="text-amber-700" />
                  <Stat label="偏低" value={landing.lowCount} color="text-blue-700" />
                </div>
              </>
            )}
          </section>
            ...
            {icr.estimatedIcr == null ? (
              ...
              <>
                <div className="flex items-baseline gap-4">
                  <div>
                    <span className="text-xs text-zinc-500">設定值</span>
